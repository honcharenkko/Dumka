...
import SmartTestMaterialPreview from "../../../components/preview_components/SmartTestMaterialPreview.jsx";
import { motion } from "framer-motion";
import {useLocation} from "react-router-dom";


export default function SmartTestForm() {
...
const detailLevelTranslations = {
  ...
  const speechStyles = {
    1: "Розмовний",     // Дружній стиль, пояснення на прикладах, як у блозі
    2: "Офіційний"      // Академічний стиль, складні речення та терміни
};
...
const sendGenData = () => {
    ...
    let route = "/generate_test"; // дефолт
...
>
      ...
      <div className="mb-4">
        <label className="block mb-2 font-semibold text-gray-700">
          Кількість питань: {formData.num_questions}
        </label>
        <input
          type="range"
          name="num_questions"
